...
const initialState = {
  data: [
    ...
    },
    {
      ...
      images: [
        'https://live.staticflickr.com/449/19398561302_df94369158_c.jpg',
        'https://images.hgmsites.net/lrg/ferrari_100420857_l.jpg'
      ],
      tabOne: [
        {
          label: 'Condition',
...
const fetchDataReducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case DELETE_CAR:
      return {
        ...state,
        data: state.data.filter((car) => car.car_id !== action.carId)
      }
    default:
      return state
  }
